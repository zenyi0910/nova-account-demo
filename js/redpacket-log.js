...
function rlShowDetail(id) {
  ...
  if (!modal) {
    ...
    modal.innerHTML = '<div class="modal" style="max-width:500px;transition:all .3s" id="rlDetailModalInner"><div class="modal-header"><h3>紅包紀錄 - 領取明細</h3><button style="background:none;border:none;cursor:pointer;color:#6B7280;padding:4px;margin-right:4px" onclick="var m=document.getElementById(\'rlDetailModalInner\');if(m.style.maxWidth===\'500px\'){m.style.maxWidth=\'90%\';m.style.maxHeight=\'90vh\'}else{m.style.maxWidth=\'500px\';m.style.maxHeight=\'85vh\'}"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" y1="3" x2="14" y2="10"/><line x1="3" y1="21" x2="10" y2="14"/></svg></button><button class="modal-close" onclick="closeRlModal()">&times;</button></div><div class="modal-body" id="rlDetailBody" style="padding:16px 20px;overflow-y:auto"></div><div class="modal-footer" style="display:flex;justify-content:flex-end;gap:8px;padding:14px 20px;border-top:1px solid #E5E7EB"><button class="btn-search" onclick="closeRlModal()" style="background:#1F2937">關閉</button></div></div>';
