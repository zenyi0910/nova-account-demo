const halls = {
  VA: {name:'VA 娛樂城',status:'on',gold:{enabled:true,min:10,max:100000,rate:'1:1'},star:{enabled:true,min:100,max:50000,rate:'10:1'},schedules:[{action:'off',start:'2026-05-20T02:00',end:'2026-05-20T04:00',note:'v3.5 版本更新'},{action:'off',start:'2026-05-22T03:00',end:'2026-05-22T05:00',note:'例行維護'},{action:'off',start:'2026-05-14T03:00',end:'2026-05-14T05:00',note:'例行維護'},{action:'off',start:'2026-05-16T02:00',end:'2026-05-16T04:00',note:'版本更新'},{action:'off',start:'2026-05-12T22:00',end:'2026-05-13T01:00',note:'緊急安全修補'},{action:'off',start:'2026-05-07T01:00',end:'2026-05-07T03:00',note:'資料庫遷移'},{action:'off',start:'2026-04-30T02:00',end:'2026-04-30T04:00',note:'SSL 憑證更新'}]},
  YGR: {name:'YGR 娛樂城',status:'on',gold:{enabled:true,min:10,max:80000,rate:'1:1'},star:{enabled:true,min:100,max:30000,rate:'10:1'},schedules:[{action:'off',start:'2026-05-21T22:00',end:'2026-05-22T02:00',note:'系統升級'},{action:'off',start:'2026-05-11T22:00',end:'2026-05-12T02:00',note:'緊急修復'},{action:'off',start:'2026-05-03T01:00',end:'2026-05-03T03:00',note:'例行維護'},{action:'off',start:'2026-04-26T02:00',end:'2026-04-26T04:00',note:'金流對帳修正'}]},
  JDB: {name:'JDB 娛樂城',status:'on',gold:{enabled:true,min:5,max:50000,rate:'1:1'},star:{enabled:true,min:50,max:20000,rate:'10:1'},schedules:[{action:'off',start:'2026-05-19T01:00',end:'2026-05-19T03:00',note:'API 版本升級'},{action:'off',start:'2026-05-15T01:00',end:'2026-05-15T03:00',note:'系統升級'},{action:'off',start:'2026-05-08T02:00',end:'2026-05-08T04:00',note:'憑證更換'},{action:'off',start:'2026-04-28T01:00',end:'2026-04-28T02:30',note:'例行維護'}]},
  PG: {name:'PG 娛樂城',status:'on',gold:{enabled:true,min:10,max:120000,rate:'1:1'},star:{enabled:false,min:0,max:0,rate:'0'},schedules:[{action:'off',start:'2026-05-25T02:00',end:'2026-05-25T04:00',note:'新遊戲上架維護'}]},
  PP: {name:'PP 娛樂城',status:'off',gold:{enabled:true,min:10,max:90000,rate:'1:1'},star:{enabled:true,min:100,max:40000,rate:'10:1'},schedules:[{action:'on',start:'2026-05-12T10:00',end:'',note:'新廳上線'},{action:'off',start:'2026-05-10T00:00',end:'2026-05-10T06:00',note:'停機維護（全廳）'},{action:'off',start:'2026-04-25T02:00',end:'2026-04-25T04:00',note:'系統更新'}]},
  CQ9: {name:'CQ9 娛樂城',status:'on',gold:{enabled:true,min:10,max:60000,rate:'1:1'},star:{enabled:true,min:100,max:25000,rate:'10:1'},schedules:[{action:'off',start:'2026-05-23T03:00',end:'2026-05-23T05:00',note:'例行維護'},{action:'off',start:'2026-05-06T00:00',end:'2026-05-06T05:00',note:'核心系統升級'}]},
  RSG: {name:'RSG 娛樂城',status:'on',gold:{enabled:true,min:20,max:100000,rate:'1:1'},star:{enabled:true,min:200,max:50000,rate:'10:1'},schedules:[{action:'off',start:'2026-05-09T03:00',end:'2026-05-09T05:00',note:'計費系統維護'}]},
  FC: {name:'FC 娛樂城',status:'on',gold:{enabled:true,min:10,max:70000,rate:'1:1'},star:{enabled:true,min:100,max:35000,rate:'10:1'},schedules:[{action:'off',start:'2026-05-24T02:00',end:'2026-05-24T04:00',note:'測試環境重建'}]}
};
...
function initHallSelector() {
  ...
  container.innerHTML = azHtml + '<div class="hall-list-header"><span class="hall-list-header-name">娛樂城</span><span class="hall-list-header-schedule"><span style="display:inline-flex;align-items:center;gap:4px">維護排程<span class="hall-schedule-tip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="12" height="12"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg><span class="hall-schedule-tip-text">娛樂城有進行中、尚未開始的維護排程</span></span></span></span><span class="hall-list-header-count">遊戲數</span><span class="hall-list-header-status">狀態</span></div><div class="hall-list-scroll">' + listHtml + '</div>';
}
...
function renderHallDetail() {
  ...
  section.innerHTML = '<div style="margin:16px 0;border:1px solid #E5E7EB;border-radius:10px;overflow:hidden;background:#f5f5f5;box-shadow:0 1px 3px rgba(0,0,0,.08),0 1px 2px rgba(0,0,0,.06)">' +
...
function toggleMoreMenu(event, gameId) {
  ...
  menu.innerHTML = '<div class="more-menu-header">操作功能</div>' +
    ...
    '<div class="more-item" onclick="openDetail(' + gameId + ')" style="color:#4338CA"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg> 檢視詳情</div>' +
